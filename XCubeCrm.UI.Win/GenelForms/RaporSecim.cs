...
using XCubeCrm.UI.Win.Forms.RaporForms;
...
using XCubeCrm.UI.Win.Report.XtraReports;
...
namespace XCubeCrm.UI.Win.GenelForms
{
    public partial class RaporSecim : BaseListForm
    {
        ...
        public RaporSecim(params object[] prm)
        {
            ...
            //    _ePosBilgileri = (IEnumerable<CariBakiyeler>)prm[7];
            //}
        ...
        protected override void Yazdir()
        {
            ...
            for (int i = 0; i < txtKopyaSayisi.Value; i++)
        ...
        protected override void Button_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            //else if (e.Item == btnMutabakat)
               // RaporOlustur(KartTuru.MutabakatRaporu, RaporBolumTuru.TahakkukRaporlari, new MutabakatRaporu());
